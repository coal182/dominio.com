...
/* Practica1Bundle:Usuario:edit.html.twig */
class __TwigTemplate_ddcb836c7f081b1882623ca1230c2e10 extends Twig_Template
{
...
<form action=\"";
        // line 3
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("manage_usuario_update", array("id" => $this->getAttribute($this->getContext($context, "entity"), "id"))), "html", null, true);
        echo "\" method=\"post\" ";
...
";
    ...
    {
        return "Practica1Bundle:Usuario:edit.html.twig";
    }
