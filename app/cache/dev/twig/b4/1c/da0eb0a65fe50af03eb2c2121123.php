...
/* Practica1Bundle:Curso:edit.html.twig */
class __TwigTemplate_b41cda0eb0a65fe50af03eb2c2121123 extends Twig_Template
{
...
<form action=\"";
        // line 3
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("manage_curso_update", array("id" => $this->getAttribute($this->getContext($context, "entity"), "id"))), "html", null, true);
        echo "\" method=\"post\" ";
...
";
    ...
    {
        return "Practica1Bundle:Curso:edit.html.twig";
    }
